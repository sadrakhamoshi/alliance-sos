...
import com.freelancers.alliancesos.Adapters.ShowGroup;
import com.freelancers.alliancesos.Adapters.SwipeToDeleteCallback;
import com.freelancers.alliancesos.Payment.PaymentActivity;
import com.freelancers.alliancesos.Payment.PaymentObject;
import com.freelancers.alliancesos.SendNotificationPack.Token;
import com.freelancers.alliancesos.Setting.UserSettingActivity;
    ...
    private void UpdateToken() {
        FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() {
            ...
            public void onComplete(@NonNull Task<String> task) {
                if (task.isSuccessful()) {
                    Token newToken = new Token(task.getResult());
